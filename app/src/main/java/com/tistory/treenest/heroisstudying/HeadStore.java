...
public class HeadStore extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_head_store);
    ...
    public void Set_Text(){
        ...
        Enter_Btn1.setText(Enter_Text(HeadDB.getInt_Head(1,2)));
        Enter_Btn2.setText(Enter_Text(HeadDB.getInt_Head(2,2)));
        Enter_Btn3.setText(Enter_Text(HeadDB.getInt_Head(3,2)));
        Enter_Btn4.setText(Enter_Text(HeadDB.getInt_Head(4,2)));
        Enter_Btn5.setText(Enter_Text(HeadDB.getInt_Head(5,2)));
        Enter_Btn6.setText(Enter_Text(HeadDB.getInt_Head(6,2)));
        Enter_Btn7.setText(Enter_Text(HeadDB.getInt_Head(7,2)));
    ...
    public void Head(int i){
        ...
        if(HeadDB.getInt_Head(i,2) == 0){
            if(HeadDB.getInt_Head(i,4) <= MainDB.getValue("STAT")){

                String name = HeadDB.getString_Head(i,3);

                Clear_Btn.setVisibility(View.VISIBLE);
                Clear_Btn.setText("구매 성공!!\n" + name);

                HeadDB.update_Head(i,1);

                MainDB.update("STAT",MainDB.getValue("STAT") - HeadDB.getInt_Head(i,4));
                MainDB.update("STAT_USE",MainDB.getValue("STAT_USE") + HeadDB.getInt_Head(i,4));
        ...
        }else if(HeadDB.getInt_Head(i,2) == 1){
            if(MainDB.getValue("HEAD") == 0){
                MainDB.update("HEAD",i);

                MainDB.update("STR",MainDB.getValue("STR") + HeadDB.getInt_Head(i,5));
                MainDB.update("INT",MainDB.getValue("INT") + HeadDB.getInt_Head(i,6));
                MainDB.update("HP",MainDB.getValue("HP") + HeadDB.getInt_Head(i,7));
                MainDB.update("DEX",MainDB.getValue("DEX") + HeadDB.getInt_Head(i,8));

                HeadDB.update_Head(i,2);

            }else{
                int k = MainDB.getValue("HEAD");

                MainDB.update("STR",MainDB.getValue("STR") - HeadDB.getInt_Head(k,5));
                MainDB.update("INT",MainDB.getValue("INT") - HeadDB.getInt_Head(k,6));
                MainDB.update("HP",MainDB.getValue("HP") - HeadDB.getInt_Head(k,7));
                MainDB.update("DEX",MainDB.getValue("DEX") - HeadDB.getInt_Head(k,8));

                HeadDB.update_Head(k,1);
        ...
        }else if(HeadDB.getInt_Head(i,2) == 2){
